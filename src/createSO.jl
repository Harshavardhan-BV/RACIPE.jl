...
create_sysimage(
    ...
    [:CSV, :DataFrames, :Distributions, :OrderedCollections, :DifferentialEquations, :ProgressMeter, :StatsBase, :ModelingToolkit, :OrdinaryDiffEq, :AMDGPU, :DiffEqGPU, :StaticArrays],

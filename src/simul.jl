...
function simulateEnsemble!(RxnNet, p, num_ini::Int64, num_nodes::Int64)
    ...
    sim = solve(ensemble_prob, Tsit5(), EnsembleGPUArray(CUDA.CUDABackend()),save_everystep=false,save_start=false,callback=TerminateSteadyState(1f-3, 1f-5),trajectories=num_ini)
